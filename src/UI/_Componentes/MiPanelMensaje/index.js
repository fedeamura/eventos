...
class MiPanelMensaje extends React.PureComponent {
  render() {
    ...
    let tieneIcono = esError || esAlerta || esExito || this.props.icono !== undefined;
    ...
    return (
      ...
      >
        {/* Icono */}
        {conLottieExito === true ? this.renderLottie(lottieExito) : this.renderIcono(icono, iconoColor)}

        {/* Texto */}
        <Typography variant="h5" style={{ marginTop: "16px", maxWidth: "30rem", textAlign: "center", fontSize: 20 }}>
          {this.props.mensaje}
        </Typography>
  ...
  renderLottie(lottie) {
    return <Lottie options={lottie} height={130} width={130} style={{ minHeight: "130px" }} />;
  }
